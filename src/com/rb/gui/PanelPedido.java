...
public class PanelPedido extends PanelCapturaMod
    ...
    private ProgAction acShowMesas;
    ...
    private void createComponents() {
        ...
        ConfigDB config = app.getControl().getConfigGlobal(Configuration.DOCUMENT_NAME);
        ...
        config = app.getControl().getConfigGlobal(Configuration.DELIVERY_VALUE);
        ...
        ImageIcon iconCancel = new ImageIcon(
                app.getImgManager().getImagen(app.getFolderIcons() + "cancel.png", 10, 10));

        btCancel.setBackground(new Color(153, 253, 255));
        btCancel.setMargin(new Insets(1, 1, 1, 1));
        btCancel.setFont(new Font("Arial", 1, 10));
        btCancel.setActionCommand(AC_CANCEL_MOD);
        ...
        regMesera.setFontCampo(new Font("Sans", 1, 18));
        ...
        ImageIcon icon = new ImageIcon(app.getImgManager().getImagen(app.getFolderIcons() + "information.png", 24, 24));
        acShowMesas = new ProgAction("", icon, "Select Mesa", 't') {
        ...
        regMesa.setAction(acShowMesas);
        regMesa.setActionCommand(AC_SHOW_SELECT_TABLES);
        regMesa.setFontCampo(new Font("Sans", 1, 18));
    ...
    public static final String AC_SHOW_SELECT_TABLES = "AC_SHOW_SELECT_TABLES";
    ...
    public static final String AC_CANCEL_MOD = "AC_CANCEL_MOD";
        ...
        if (AC_CONFIRMAR_PEDIDO.equals(e.getActionCommand())) {
            ...
            try {
                if (verificarDatosFactura()) {
                    ...
                    ConfigDB config = app.getControl().getConfigLocal(Configuration.AUTO_SEND_ORDER_TO_STATIONS);
                    ...
                    pcs.firePropertyChange(AC_CONFIRMAR_PEDIDO, null, null);
                }
            } catch (Exception ex) {
            ...
            ConfigDB config = app.getControl().getConfigGlobal(Configuration.PRINT_PREV_DELIVERY);
            ...
            if (cycle != null && cycle.getId() != inv.getCiclo()) {
                GUIManager.showErrorMessage(this, "La Orden no pertenece al ultimo ciclo, no se puede editar",
                        "Orden no pertenece al ciclo");
                return;
            }

            Map pago = app.getControl().facturaIsPaga(inv.getFactura());
            if (pago != null && !pago.isEmpty()) {
                GUIManager.showErrorMessage(this, "La factura esta paga, no puede modifcarse", "Orden paga");
                return;
            }
...
//            copyInvoiceToLocal(invoice);  
            ...
            btConfirm
                    .setIcon(new ImageIcon(app.getImgManager().getImagen(app.getFolderIcons() + "success.png", 10, 10)));
...
//                    oldProducts = invoice1.getProducts();
                    ...
                    Permission perm = app.getControl().getPermissionByName(MyConstants.PERM_MOD_ORDER);
                    boolean hasPermission = app.getControl().hasPermission(app.getUser(), perm);
                    btPrint.setEnabled(true);
            ...
            try {
                color = Color.decode(waitres.getStColor());
            } catch (Exception ex) {
            }
        ...
        } else if (AC_CANCEL_MOD.equals(e.getActionCommand())) {
            block = true;
            enablePedido(false);
    ...
    public void printBill() {
        if (invoice != null) {
            Pay pay = app.getControl().getPay(invoice.getFactura());
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (PanelProduct2.AC_ADD_QUICK.equals(evt.getPropertyName())) {
            ...
            loadInvoice(invoice);
        } else if (PanelNewWaiter.AC_NEW_WAITER.equals(evt.getPropertyName())) {
            loadWaiters();
        }
    ...
    private void loadInvoice(Invoice invoice1) {
        loadInvoice(invoice1, true);
    }

    private void loadInvoice(Invoice invoice1, boolean mod) {
        ...
        ConfigDB config = app.getControl().getConfigLocal(Configuration.AUTO_SEND_ORDER_TO_STATIONS);
        String property = config != null ? config.getValor() : "false";
        boolean permit = Boolean.parseBoolean(property) && mod;
        if (permit) {
            btPrint.setEnabled(false);
        } else {
            btPrint.setEnabled(true);
        ...
        //btPrint.setVisible(true);
        Permission perm = app.getControl().getPermissionByName(MyConstants.PERM_PRINT_INVOICE);
        boolean hasPermission = app.getControl().hasPermission(app.getUser(), perm);
        btPrint1.setVisible(true);
        btPrint1.setEnabled(hasPermission);
    ...
    private boolean validateInvoiceData() {
        ...
        if (!checkAllInventory()) {
            ConfigDB config = app.getControl().getConfigGlobal(Configuration.INVOICE_OUT_STOCK);
            String property = config != null ? config.getValor() : "false";
            boolean permit = Boolean.valueOf(property);
    ...
    public Invoice getInvoice(boolean calcRegister) {
        ...
        List<ProductoPed> listaProd = new ArrayList<>();
        int cantProd = modeloTb.getRowCount();
        for (int i = 0; i < cantProd; i++) {
            ProductoPed prodP = (ProductoPed) tbListado.getValueAt(i, 1);
            prodP.setCantidad(Integer.parseInt(tbListado.getValueAt(i, 0).toString()));
            listaProd.add(prodP);
        }

        invoice.setProducts(listaProd);
    ...
    private String calculateProximoRegistro() {
        ...
        ConfigDB config = control.getConfigGlobal(Configuration.PREFIX_INVOICES);
    ...
    private String getConsecutivoFactura() {
        ...
        ConfigDB cfFactura = app.getControl().getConfigGlobal(MyConstants.CF_FACTURA_ACTUAL);
        if (cfFactura != null) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btTogle1, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btTogle2, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btTogle1, btTogle2});
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btTogle1, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lbFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btInventoryInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(regMesa, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(btInventoryInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(7, 7, 7)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(regMesera, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(3, 3, 3)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(btCancel, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(3, 3, 3)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btCancel, btConfirm, btPrint, btPrint1, containerPanels, lbDescuento1, regDescuento, regSubtotal, regTotal});

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btDelete, btInventoryInfo, jPanel1, lbFactura, lbTitle});
    ...
    public class WaiterListCellRender extends JLabel implements javax.swing.ListCellRenderer<Object> {
        ...
        public Component getListCellRendererComponent(JList<? extends Object> list, Object value, int index,
            ...
            if (value != null && value instanceof Waiter) {
                ...
                Color color = Color.BLACK;
                try {
                    color = Color.decode(waiter.getStColor());
                } catch (Exception e) {
                }
