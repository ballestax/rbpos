...
public class PanelAccess extends JPanel {
    ...
    public PanelAccess(Aplication app, ActionListener listener, User user) {
        ...
        add(regUser, new GridBagConstraints(3, 1, 2, 1, 0.1, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.HORIZONTAL, new Insets(15, 2, 2, 7), 100, 16));
        ...
        boxBtns.add(btns[0]);
        add(boxBtns, new GridBagConstraints(0, 5, 7, 1, 1.0, 0.1, GridBagConstraints.CENTER,
    ...
    private void crearComponentes() {
        ...
        btnKeyboard.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // KeyBoardWindow keyBoardWindow = KeyBoardWindowBuilder.create().initLocale(Locale.forLanguageTag("es"))
                //         .layer(DefaultLayer.NUMBLOCK).build();
                // KeyboardUIManagerTool.installKeyboardDefaults(keyBoardWindow);
                // KeyBoardWindow window =
                // KeyBoardWindowBuilder.create().initLocale(Locale.forLanguageTag("es"))
                // .addIRobot(new AWTRobotHandler()).layer(DefaultLayer.NUMBLOCK).build();
